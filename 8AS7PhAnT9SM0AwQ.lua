...
if getgenv().SonicEXE_Executed then
    ...
    if vu15 and typeof(vu15) == "function" then
        ...
        if loadstring(game:HttpGet("https://raw.githubusercontent.com/secretisadev/Phantasm/refs/heads/main/Active.lua"))() then
            ...
            vu442.Name = "Thrown"
            vu442.Parent = vu7
            vu42[# vu42 + 1] = v441.ChildAdded:Connect(function(pu450)
                task.spawn(function()
                    local v451 = tick()
                    repeat
                        vu21:Wait()
            ...
            local vu454 = {}
            vu42[# vu42 + 1] = vu442.ChildAdded:Connect(function(p455)
                task.wait()
            ...
            vu42[# vu42 + 1] = vu7:GetPropertyChangedSignal("FallenPartsDestroyHeight"):Connect(function()
                vu7.FallenPartsDestroyHeight = 0 / 0
            end)
            ...
            vu42[# vu42 + 1] = workspace.AttributeChanged:Connect(function(p518)
            ...
            if v840 and v841 then
                ...
                local function v854(p845)
                    ...
                    if p845:IsA("Frame") and (tonumber(p845.Name) and v846) then
                        vu42[# vu42 + 1] = v846.MouseButton1Click:Connect(function()
            ...
            local vu856 = nil
            function init(_)
                local v857, v858, v859 = pairs(vu41)
                while true do
                    local v860
                ...
                if vu861 and (vu862 and vu863) then
                    ...
                    local vu879 = nil
                    local v880 = vu21
                    vu41[# vu41 + 1] = v880:Connect(function()
                    ...
                    vu41[# vu41 + 1] = vu863.HealthChanged:Connect(function(p894)
                        if p894 <= 0 and vu862.CFrame.Y <= 0 then
                            vu863.Health = vu876
                        end
                    end)
                    vu41[# vu41 + 1] = vu861.AttributeChanged:Connect(function(p895)
                    ...
                    vu41[# vu41 + 1] = vu863.AnimationPlayed:Connect(function(pu915)
                    ...
                    local vu1000 = {}
                    vu41[# vu41 + 1] = vu861.DescendantAdded:Connect(function(pu1001)
                        if table.find({
                            "BODYGYRO",
                            "BodyGyroBind"
            ...
            function initOthers(pu1018)
                if not vu43[pu1018] then
                    vu43[pu1018] = {}
                end
                if vu45.Players[pu1018] then
                    local v1019, v1020, v1021 = pairs(vu45.Players[pu1018])
                    while true do
                        local v1022
                    ...
                    table.remove(vu45.Players, table.find(vu45.Players, pu1018))
                end
                vu45.Players[pu1018] = {}
                local v1023, v1024, v1025 = pairs(vu43[pu1018])
                while true do
                    local v1026
                ...
                table.clear(vu43[pu1018])
                repeat
                    task.wait()
                until getChar(pu1018) and (getRoot(getChar(pu1018)) and getHumanoid(getChar(pu1018))) or not vu43[pu1018]
                ...
                if vu1027 and (vu1028 and (vu1029 and vu43[pu1018])) then
                    task.spawn(function()
                        local v1030 = vu1027
                        ...
                        while true do
                            ...
                            if vu1034:IsA("BasePart") and (vu1034 ~= vu1028 and vu1034.Transparency ~= 1) and not vu1034.Name:lower():find("hitbox") then
                                task.spawn(function()
                                    while task.wait() and (not getChar(pu1018) or getChar(pu1018) == vu1027) and vu43[pu1018] do
                    ...
                    table.insert(vu45.Players[pu1018], vu1044)
                    table.insert(vu45.Players[pu1018], vu1045)
                    local v1046 = vu21
                    vu43[pu1018][# vu43[pu1018] + 1] = v1046:Connect(function()
                    ...
                    vu43[pu1018][# vu43[pu1018] + 1] = vu1027.ChildAdded:Connect(function(p1062)
                    ...
                    vu43[pu1018][# vu43[pu1018] + 1] = vu1029.AnimationPlayed:Connect(function(pu1088)
            ...
            vu42[# vu42 + 1] = vu5.CharacterAdded:Connect(function()
            ...
            while true do
                ...
                if vu1432.Name ~= vu5.Name then
                    ...
                    vu42[# vu42 + 1] = vu1432.CharacterAdded:Connect(function()
                        task.spawn(initOthers, vu1432)
                    end)
                end
            end
            vu42[# vu42 + 1] = vu4.PlayerAdded:Connect(function(pu1443)
            ...
            vu42[# vu42 + 1] = vu4.PlayerRemoving:Connect(function(p1487)
                if vu43[p1487] then
                    local v1488, v1489, v1490 = pairs(vu43[p1487])
                    while true do
                        local v1491
                    ...
                    if vu45.Players[p1487] then
                        local v1492, v1493, v1494 = pairs(vu45.Players[p1487])
                        while true do
                            local v1495
                        ...
                        table.remove(vu45.Players, table.find(vu45.Players, p1487))
                    end
                    table.clear(vu43[p1487])
                    vu43[p1487] = nil
                    table.remove(vu43, table.find(vu43, p1487))
                end
            ...
            vu42[# vu42 + 1] = vu21:Connect(function()
